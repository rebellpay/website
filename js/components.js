  ...
  <div class="nav-inner"> 
    <div class="logo">
        <a href="{BASE}index.html">
            <img src="{BASE}_RebellPay_logotype.png" alt="Rebell Pay">
        </a>
    </div>
...
// zmiana base na link
const base = "https://rebellpay.github.io/website/";

// adjust "html" if your field has a different name
const html = $json.html.replace(/{BASE}/g, base);
...
// 3. LOGIKA INJEKCJI (Pozostaje bez zmian)
function injectComponents() {
    const isBlogFolder = window.location.pathname.includes('/blog/');
