...
<header>
  <div class="nav-inner"> 
    <div class="logo">
        <a href="index.html">
            <img src="js/_RebellPay_logotype.png" alt="Rebell Pay">
        </a>
    </div>
...
<footer>
  <div class="footer-links-grid">
        <div>
            <div class="logo"><img src="js/_RebellPay_logotype.png" alt="Rebell Pay" style="height: 30px; margin-bottom: 20px;"></div>
